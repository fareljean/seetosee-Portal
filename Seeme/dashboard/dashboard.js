...
const communicationsScript=document.createElement('script');communicationsScript.src='communications.js?v=1.0.0';communicationsScript.defer=true;document.head.appendChild(communicationsScript);
})();
